...
<template>
  <BaseCard title="Exchange Rates">
    <div class="space-y-4">
      ...
      <div class="flex items-center justify-between">
        <div>
          <p class="text-sm text-gray-500 dark:text-gray-400">
            Last updated:
            <span
              :class="isStale ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-700 dark:text-gray-300'"
            >
              {{ lastUpdateFormatted }}
            </span>
          </p>
          <p v-if="isStale" class="text-xs text-yellow-600 dark:text-yellow-400 mt-1">
      ...
      <!-- Error message -->
      <div v-if="updateError" class="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
      ...
      <div v-if="exchangeRates.length > 0" class="border-t border-gray-100 dark:border-slate-700 pt-4">
      ...
      <!-- Empty state -->
      <div v-else class="text-center py-6 border-t border-gray-100 dark:border-slate-700">
        <svg
